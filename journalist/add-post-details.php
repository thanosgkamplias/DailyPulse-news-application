    ...
    if (!empty($heading) && !empty($detail) && !empty($thumbnail_name)) {
        ...
        if ($result_add_desc) {
            ...
            if ($result) {
                ...
                // Increasing the number of posts in the category by 1 when a post is added to that category
    ...
    <div id="form" class="pt-5 form-input-content">
        <div class="card login-form mb-0">
            <div class="card-body pt-3 shadow">
                <h4 class="text-center">Create Post Details</h4>
                        ...
                        <select name="heading" class="form-control">
                            ...
                            if (mysqli_num_rows($post_heading) > 0) {
                                while ($rows = mysqli_fetch_assoc($post_heading)) {
                                    ...
                                    ?>
                                    <option value='<?php echo $p_heading ?>' <?php if ($p_heading == $heading) {
                                        echo 'selected';
                                    } ?>  > <?php echo$p_heading ?></option>
                                    <?php
                                }
                            }
                            ?>
