<div class="col-lg-12 col-md-4 col-sm-4">
        ...
        <div class="latest_post">
            <!-- Τίτλος "Τελευταία Νέα" -->
            <h2><span>Τελευταια Νεα</span></h2>
            <div class="latest_post_container" style="height:500p; overflow: auto;">
          ...
          <!-- Πλευρικό περιεχόμενο (π.χ. κατηγορίες, σύνδεσμοι) -->
          <div class="single_sidebar">
          <div class="latest_post">
            <h2><span>Θεματα</span></h2>
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="category">
                <ul>
                <!-- Επιλογή όλων των κατηγοριών -->
                <li class="cat-item">  <a href="all-posts.php">ΟΛΑ</a>  </li>
                <!-- Προσθήκη κατηγοριών -->
                    <?php
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <?php
            ...
            <!-- Τίτλος "Επικοινωνια" -->
            <h2>Επικοινωνια</h2>
            <p>Επικοινωνηστε μαζι μας.</p>
            <address>
              <!-- Εμφάνιση διεύθυνσης, τηλεφώνου και email -->
