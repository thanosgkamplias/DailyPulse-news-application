    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="slick_slider">
                <!-- Εδώ μπορεί να εισαχθεί ένας εικονίδιο slider ή άλλο περιεχόμενο -->
            </div>
            <!-- Προσθήκη carousel -->
            <?php
            // Επιλογή των 5 πιο πρόσφατων ειδήσεων από τον πίνακα post_description
            ...
            if($latest_n){
                ...
                <div class="single_iteam">
                    <a href="read-post.php?id=<?php echo $news_id ?>">
                        <img src="admin/upload/carousel/<?php echo $img; ?>" >
                    </a>
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="left_content">
                <div class="single_post_content">
                    <?php
                    // Επιλογή των ονομάτων των κατηγοριών ειδήσεων από τον πίνακα post_category
                    ...
                    if($result){
                        while( $rows = mysqli_fetch_assoc($result) ){
                            ...
                            // Επιλογή της πιο πρόσφατης είδησης από κάθε κατηγορία
                            if($cat_name ){
                                ...
                                if( $result_news ){
                                    ...
                                    while( $rows_news= mysqli_fetch_assoc($result_news) ){
                                        ...
                                        $id_n = $rows_news["p_id"];
                                        ?>
                                        <!-- Εμφάνιση μεγάλης είδησης στην αριστερή πλευρά -->
                                        <div class="row">
                                            <div class="col-lg-12 col-md-6 col-sm-12">
                                                <ul class="wow fadeInDown">
                                                    <li>
                                                        <a href="read-post.php?id=<?php echo $id_n ?>" >
                                                            <img alt="" style="height:300px; " class="img-fluid img-responsive" src="admin/upload/thumbnail/<?php echo $news_thumb; ?>">
                                                        </a>
                                                        <div>
                                                            <a href="read-post.php?id=<?php echo $id_n ?>" >
                                                        ...
                                                        <div>
                                                            <a href="read-post.php?id=<?php echo $id_n ?>" >
                                                                <?php echo ucwords($news_description); ?>
                                                            </a>
                                                        </div>
                                                    </li>
                                                </ul>
                                ...
                                if( $small_news_result ){
                                    while( $small_rows = mysqli_fetch_assoc($small_news_result) ){
                                        ...
                                        ?>
                                        <!-- Προσθήκη 5 μικρών ειδήσεων στη δεξιά πλευρά -->
                                            ...
                                            <div class=" col-lg-2 col-md-2 col-sm-6">
                                                <ul class="wow fadeInDown">
                                                    <li>
                                                        <div>
                                                            <a href="read-post.php?id=<?php echo $id_n ?>" >
                                                                <img style="height:60px;" class="img-fluid img-responsive" src="admin/upload/thumbnail/<?php echo $small_thumb; ?>">
                                                            </a>
                                                        </div>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                <ul class="wow fadeInDown">
                                                    <li>
                                                        <div>
                                                            <a href="read-post.php?id=<?php echo $id_n ?>" >
                                                                <?php echo ucwords($small_headline); ?>
                                                            </a>
                                                        </div>
                                                        <br>
                                                    </li>
                                ...
                                <div style="position: relative;">
                                    <a href="read-category.php?category=<?php echo$cat_name; ?>" style="position: absolute; bottom: 8px; right: 16px; color:#3d85c6;">see more...</a>
                                </div>
                                <!-- Τέλος δείτε περισσότερα -->
                                <?php
                            }
                        }
                    }
