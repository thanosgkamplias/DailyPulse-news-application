<?php
    session_start();
    // Έλεγχος εάν η συνεδρία έχει ενεργοποιηθεί, αν όχι, ανακατεύθυνση στη σελίδα σύνδεσης
...
<head>
    ...
    <title>DailyPulse - Καρτελα Επιμελητη</title>
                   ...
                   <br> <br>
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./add-category.php"> <i class="icon-plus menu-icon"></i>Create Topic</a></li>
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./add-post-desc.php"> <i class="icon-plus menu-icon"></i>Create Post Description</a></li>
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./add-post-details.php"><i class="icon-plus menu-icon"></i>Create Post</a></li>
