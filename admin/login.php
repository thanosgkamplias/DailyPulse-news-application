...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha384-KyZXEAg3QhqLMpG8r+g5fz5Vz4pOCSg3p50kq8GzS1z7O6FP5LW5W5n5/6E5I5MW5" crossorigin="anonymous">
  ...
  <div class="login-form-bg h-100">
        <div class="container h-100">
            <div class="row justify-content-center h-100">
                <div class="col-xl-6">
                  <!-- Add a home button that redirects to index.php -->
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                    ...
                                    <h4 class="text-center">Hello, Curator</h4>
                                ...
                                <form method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                                    ...
                                    <div class="signin-link">Are you a Journalist? <a href="../journalist/login.php">Log in here</a></div>
                                </form>
                            </div>
                        </div>
                    </div>
